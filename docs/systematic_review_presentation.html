...
<head>
  ...
  <title>Systematic Review with Active Learning</title>
  <style type="text/css">
...
<p>Systematic literature reviews are a method of making sense of large bodies of information, and a means of contributing to the answers to questions about what works and what does not – and many other types of question too. They are a method of mapping out areas of uncertainty, and identifying where little or no relevant research has been done, but where new studies are needed.</p>
<p>Systematic reviews also flag up areas where spurious certainty abounds. These are areas where we think we know more than we do, but where in reality there is little convincing evidence to support our beliefs. <a href="https://doi.org/10.1002/9780470754887">(Petticew &amp; Roberts, 2005, pp. 2</a>)</p>
<h2 id="systematic-review-vs-meta-analysis-vs-narrative-review">Systematic review vs meta-analysis vs Narrative review</h2>
<p>A systematic review answers strives to comprehensively identify, appraise, and synthesize all the relevant studies on a given topic. Systematic reviews are often used to test just a single hypothesis, or a series of related hypotheses.</p>
<p>A meta-analysis uses a specific statistical technique for synthesizing the results of several studies into a single quantitative estimate (i.e., a summary effect size).</p>
<p>A narrative review is the process of synthesizing primary studies and exploring heterogeneity descriptively, rather than statistically. <a href="https://doi.org/10.1002/9780470754887">(Petticew &amp; Roberts, 2005, pp. 19</a>)</p>
<h2 id="why-do-a-systematic-review">Why do a systematic review?</h2>
<p>It is a fair criticism of scientific research that it is often difficult to know which, if any, study to believe.</p>
<blockquote>
<p>Newton’s Third Law of Motion: ‘‘For every expert there is an equal and opposite expert.’’</p>
</blockquote>
<p>The traditional scientific approach to this problem is to carry out a literature review.</p>
<p>However, traditional literature reviews frequently summarize highly unrepresentative samples of studies in an unsystematic and uncritical fashion.</p>
<p>But the problem is not just one of inconsistency, but one of information overload.</p>
<p>The massive expansion of research output, both in peer-reviewed publications, and unpublished, e.g. in conference presentations or symposia, mean it is difficult to establish what work has been done in your area already, and to ensure that knowledge keeps up to date with the best research evidence.</p>
<h2 id="the-role-of-systematic-literature-reviews">The role of systematic literature reviews</h2>
<p>Systematic reviews are literature reviews that adhere closely to a set of scientific methods that explicitly aim to limit systematic error (bias), mainly by attempting to identify, appraise and synthesize all relevant studies (of whatever design) in order to answer a particular question (or set of questions).</p>
<p>Systematic review will be most useful when:</p>
<p>• there is a clear and defined research question</p>
<p>• several empirical studies have been published</p>
<p>• there is uncertainty about the results</p>
<hr />
<h1 id="tutorial-my-first-systematic-review-with-active-learning">Tutorial: My first systematic review with active learning</h1>
<p>A systematic review needs a detailed protocol that describes how the review will be processed and methods that will be applied. There are several published examples of such protocols. Here we follow the protocol suggested by <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6148622/">Bramer et al. (2018)</a> which consists on the following steps:</p>
<ol style="list-style-type: decimal">
<li><p>Determine a clear and focused question</p></li>
<li><p>Describe the articles that can answer the question</p></li>
<li><p>Decide which key concepts address the different elements of the question</p></li>
<li><p>Decide which elements should be used for the best results</p></li>
<li><p>Choose an appropriate database and interface to start with</p></li>
<li><p>Document the search process in a text document</p></li>
<li><p>Identify appropriate index terms in the thesaurus of the first database</p></li>
<li><p>Identify synonyms in the thesaurus</p></li>
<li><p>Add variations in search terms</p></li>
<li><p>Use database-appropriate syntax, with parentheses, Boolean operators, and field codes</p></li>
<li><p>Optimize the search</p></li>
<li><p>Evaluate the initial results</p></li>
<li><p>Check for errors</p></li>
<li><p>Translate to other databases</p></li>
<li><p>Test and reiterate</p></li>
</ol>
...
<p><img src="./optimize2.png" style="width:120.0%" alt="Results" /></p>
...
<p><img src="./optimize3.png" style="width:120.0%" alt="Add synonyms" /></p>
...
<p><img src="./FlowChart.png" style="width:70.0%" alt="Illustration of ASReview" /></p>
...
<p><img src="./asreview1.png" style="width:80.0%" alt="ASreview" /></p>
<blockquote>
...
<p><img src="./asreview3.png" style="width:80.0%" alt="Relevant" /></p>
<blockquote>
...
<p><img src="./asreview5.png" style="width:80.0%" alt="Statistics" /></p>
